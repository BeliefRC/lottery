...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(85), __webpack_require__(114)(module)))
    ...
    _createClass(Timer, [{
        ...
        value: function countDown(end, update, handle) {
            ...
            if (now - end) {
                ...
                var theHour = 60 * 60 * 1000;
                var theMinute = 60 * 1000;
                var theSecond = 1000;
                var lastDay = Math.floor(lastTime / theDay);
                var lastHour = Math.floor((lastTime - lastDay * theDay) / theHour);
                var lastMinute = Math.floor((lastTime - lastDay * theDay - lastHour * theHour) / theMinute);
                var lastSecond = Math.floor((lastTime - lastDay * theDay - lastHour * theHour - lastMinute * theMinute) / theSecond);
                // 将剩余时间的信息保存到时间结果中
                var timeResult = [];
                if (lastDay > 0) {
